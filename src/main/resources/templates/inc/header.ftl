	...
	<div class="container">
		<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
			<a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
				<img src="/images/tou.png" alt="dailyhub" height="38px">
			</a>

			<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0"
			    style="margin: 0 auto;">
				<li><a href="/" class="nav-link px-2 link-secondary ">我的收藏</a></li>
				<li><a href="/collect-square" class="nav-link px-2 link-secondary">大家的收藏</a></li>
				<li><a href="#" class="nav-link px-2 link-secondary">友情链接</a></li>
			</ul>
